# ✂️🪨📄 ROCK PAPER SCISSORS TELEGRAM BOT | ربات سنگ کاغذ قیچی تلگرام
...
> ℹ️ این نسخه از ربات امکان دعوت دوستان (invite friends) ندارد؛ تصویر «جمع دوستان» فعلاً در کد استفاده نشده است.
